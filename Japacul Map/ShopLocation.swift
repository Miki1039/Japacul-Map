...
class ShopLocationList: NSObject {
  ...
  override init(){
    ...
    shop += [ShopLocation(name:"たくみ", lat:35.669531,long:139.760409,addInfo:"info")]
    
    shopDetails[15] = ["備後屋","test","詳細を記入"]
    shop += [ShopLocation(name:"備後屋", lat:35.699293,long:139.717820,addInfo:"info")]
